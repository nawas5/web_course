...
raw_df1 = pd.read_csv("data/source/Sample_Game_1_RawTrackingData_Away_Team.csv.gz")
# sample every 5th row
raw_df1 = raw_df1.iloc[::7, :]

raw_df2 = pd.read_csv("data/source/Sample_Game_1_RawTrackingData_Home_Team.csv.gz")
